...
public class PersonDarkArts {
    ...
    private PersonDarkArts(Builder builder) {
    ...
    public interface OptionalFieldsSetter {
        ...
        PersonDarkArts build();
    }

    public static class Builder implements FirstNameOrEmailSetter,
            LastNameSetter,
            EmailOrOptionalFieldsSetter,
            NameOrOptionalFieldsSetter,
            LastNameThenOptionalFieldsSetter,
            OptionalFieldsSetter {
        ...
        public PersonDarkArts build() {
            ...
            return new PersonDarkArts(this);
        }
    }
}